...
class OrderDetail extends Component {
    ...
    calculateSubTotals(){
        ...
        let tax = 0.00;
        let total = 0.00;
        for (let i = 0; i < this.props.location.state.order.orderLineItems.length; i++) {
    ...
    render() {
        ...
        return (
            <div className="w-50 mx-auto">
                ...
                <p><b>Created on: </b>{order.create_At}</p>
                <p><b>Paid?: </b>{order.paid? 'TRUE' : 'FALSE'}</p>
                <p><b>Status: </b>{order.status}</p>
                <p><b>Last Updated: </b>{order.update_At}</p>
                <hr className="my-5"/>
                <h2>Items</h2>
